...
Ext.define('Ext.ux.TreePicker', {
    ...
    config: {
        ...
        minPickerHeight: 100,
        /**
         * @cfg {Number} minPickerWidth
         * The minimum width of the tree dropdown. Defaults to 100.
         */
        minPickerWidth : 100,
        /**
         * 根节点是否显示，默认显示
    ...
    createPicker: function() {
        var me = this,
            picker = new Ext.tree.Panel({
                ...
                columns: me.columns,
                height : 200,//树下拉框暂定固定高度，防止数据请求太慢渲染不上
    ...
    onAfterItemExpand : function(node){
    	//节点展开后定位到所选节点
		this.picker.selectPath(node.getPath());
    },
     ...
     * @return {}
     */
    setMyRawValue: function(value,displayValue) {
        var me = this;
        me.value = value;
